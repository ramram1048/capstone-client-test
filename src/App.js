...
const menus = [
  {component: "👔상의", path: "/productList/category?category=1"},
  {component: "👖하의", path: "/productList/category?category=2"},
  {component: "🎀패션잡화", path: "/productList/category?category=3"},
  {component: "🥾신발", path: "/productList/category?category=4"},
